...
over-approximated and show all effects that can possibly happen in the computations.
Note that it does not matter what argument we supply, since it will never get evaluated,
e.g. the analysis will succeed and give us the same result even if we supply \hs{undefined}.
